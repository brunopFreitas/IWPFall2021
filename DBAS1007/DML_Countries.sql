...
VALUES 
    ...
    ("Cayman Islands",56732,102),
    ("Central African Republic",4950027,240534),
    ("Chad",10758945,495752),
    ("Chile",16888760,292258),
    ("China",1336718015,3705386),
    ("Christmas Island",2072,52),
    ("Colombia",44725543,439733),
    ("Comoros",794683,838),
    ("Cook Islands",91,19569),
    ("Democratic Republic of the Congo",71712867,905563),
    ("Republic of the Congo",4243929,132046),
    ("Costa Rica",4576562,19730),
    ("Côte d'Ivoire",21504162,124502),
    ...
    ("Russian Federation",138739892,6592735),
    ...
    ("United States of America",313232044,3718691),
